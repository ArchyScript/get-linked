    ...
    <div class="grid grid-cols-3 gap-x-8"> 
      <section class="col-span-2 space-y-6 items-center mb-16">
            ...
            <form class="mt-8 grid grid-cols-2 gap-4"  @submit.prevent="updateKYCDetails">
              ...
              <div class="col-span-2 flex-col space-y-2"> 
                ...
                <div class="w-3/5 flex items-center space-x-0">
                  <el-radio-group v-model="companyDetailsPayload.company_financial_intermediary" class="!w-full  ">
              ...
              <div class="col-span-2 flex-col space-y-2"> 
                ...
                <div class="w-3/5 flex items-center space-x-0">
                  <el-radio-group v-model="companyDetailsPayload.aml_appropriate_regulation" class="!w-full  ">
                    <el-radio label="yes" border class="flex-1 !h-[3rem] !px-4 ">Yes</el-radio>
                    <el-radio label="no" border class="flex-1 !h-[3rem] !px-4">No</el-radio>
                  </el-radio-group> 
                </div>
              ...
              <div class="col-span-2 flex-col space-y-2"> 
                ...
                <div class="w-3/5 flex items-center space-x-0">
                  <el-radio-group v-model="companyDetailsPayload.appropriate_prudential_supervision" class="!w-full  ">
                    <el-radio label="yes" border class="flex-1 !h-[3rem] !px-4 ">Yes</el-radio>
                    <el-radio label="no" border class="flex-1 !h-[3rem] !px-4">No</el-radio>
                  </el-radio-group> 
                </div>
              ...
              <div class="col-span-2 flex-col space-y-2"> 
                ...
                <div class="w-3/5 flex items-center space-x-0">
                  <el-radio-group v-model="companyDetailsPayload.investigated_for_money_laundering" class="!w-full  ">
                    <el-radio label="yes" border class="flex-1 !h-[3rem] !px-4 ">Yes</el-radio>
                    <el-radio label="no" border class="flex-1 !h-[3rem] !px-4">No</el-radio>
                  </el-radio-group> 
                </div>
        ...
        <CardContainer class="!p-5 rounded-md  space-y-2 w-full">
          ...
          <div class="flex pt-3"> 
            <Button @click="showDeleteModal = true" text="Delete my account"  class="!w-auto py-3 !px-6 !bg-error-50 !text-error-500"  :hasIcon="true" iconName="trash"   /> 
          </div>
        </CardContainer>
      </section>
...
const activePayload: any = computed(() => {
  if (activeTabId.value == 'rep_details') return activePayload.value = representativeDetailsPayload.value
...
const fetchDataFromStore = async () => { 
  ...
  const { first_name, last_name, address, nationality, title, phone_number, company_name, company_reg_number, company_address, company_financial_intermediary, aml_appropriate_regulation, appropriate_prudential_supervision, investigated_for_money_laundering } = authUser.value?.kyc
  ...
  companyDetailsPayload.value.appropriate_prudential_supervision = appropriate_prudential_supervision
  companyDetailsPayload.value.investigated_for_money_laundering = investigated_for_money_laundering
