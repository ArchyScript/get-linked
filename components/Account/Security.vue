    ...
    <section class="col-span-2 space-y-6 items-center">
      <CardContainer class="!p-5 rounded-md !pr-8 space-y-4 w-full">
        ...
        <div class="space-y-4" v-else>
          <TypoHeaderText size="sm" customClass="!text-grey-300 py-3 border-b-[1.5px] border-ui-bg"> Setup Two factor verification to increase security </TypoHeaderText> 
 
        <div class="space-y-4">
          <div v-for="twoFA in twoFAs" :key="twoFA.title" class="space-y-2 ring-[1.5px] rounded-lg ring-primary-500 py-6 !px-5">
            ...
            <div class="pt-2" v-if="toggleValue">
              <div class="flex bg-primary-50 items-center justify-between  px-3.5 py-3 rounded-md  space-x-3"> 
                <div class=" flex items-center space-x-1.5 !text-success-400">
                  <IconCheckbox type="square" />

                  <TypoNormalText size="xs" customClass="!text-grey-400 !font-normal !leading-[160%]"> 
                    Added June 24, 2021
                  </TypoNormalText>  
                </div>
                
                <div class=" flex items-center space-x-1.5"> 
                  <TypoNormalText size="xs" customClass="!text-grey-400 !font-semibold !leading-[160%]"> 
                    Binded phone number:
                  </TypoNormalText>  

                  <TypoNormalText size="xs" customClass="!text-grey-400 !font-medium !leading-[160%]"> 
                    +562023237239
                  </TypoNormalText>
                </div>
                
                <TypoNormalText size="xs"  @click="toggleValue = !toggleValue" customClass="!text-primary-500 cursor-pointer !font-medium !leading-[160%]"> 
                  change
                </TypoNormalText>   
              </div>
            </div>
