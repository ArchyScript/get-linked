    ...
    <div v-else>  
      ...
      <div v-else class="space-y-0.5">
        ...
        <div class="camera" v-if="!dataImageUrl">
          <video id="video" ref="videoElement" class="!w-full" autoplay>Video stream not available.</video>
        </div>
...
const validatePicture = async (): Promise<void> => { 
  ...
  if (!dataImageUrl.value.length) return handleError('Please take a clear picture of your face to proceed');
  onValidate() 
};   
const startup = () => { 
