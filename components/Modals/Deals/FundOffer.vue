<template>
  <form @submit.prevent="fundRequest">
    <div class="space-y-6">
      <TypoHeaderText size="lg" customClass="!text-black !font-semibold">Fund Offer</TypoHeaderText>
      ...
      <div class="space-y-4">
            ...
            <div class="col-span-3 space-y-4">
              ...
              <div class="space-y-2">
                ...
                <div class="flex items-center space-x-2 px-4 bg-input-bg w-full rounded truncate">
                  <TypoNormalText
                    size="sm"
                    customClass="input-field !text-grey-500 !truncate !font-Montserrat"
                  >
                    To ensure a secure and successful trade, your funds will be held in escrow or a
                    de
                  </TypoNormalText>
        ...
        <div class="flex space-x-2 justify-center items-center">
          ...
          <TypoNormalText
            size="sm"
            customClass="!text-grey-500 !leading-[160%] select-none cursor-pointer flex-1"
