<template>  
  ...
  >
    ...
    <div class="flex flex-col justify-center items-center" :class="hasTitle ? 'space-y-1' : 'space-y-6'">
      <TypoHeaderText size="xl" customClass="text-grey-500 font-semibold text-center" v-if="hasTitle">
        {{titleText}}
      </TypoHeaderText> 

      <TypoNormalText :size="hasTitle ? 'base' : 'lg'" customClass="text-grey-500 font-normal text-center">
        {{message}}
      </TypoNormalText>  
    </div>
