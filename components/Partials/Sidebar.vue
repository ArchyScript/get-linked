  ...
  <div class="overflow-y-auto no-scrollbar overflow-x-hidden py-6 flex flex-col flex-grow">
    <div class="py-2">
      ...
      <div class=" flex items-center space-x-2 py-1 px-4 ">
        <span class=" h-11 w-11 text-xs font-semibold  bg-white text-secondary-500 border border-secondary-500 rounded-full flex  justify-center items-center">
          MH
        </span>

        <div class=" flex-1">
          <h5 class="text-secondary-50 text-base font-medium mb-0">
            Bank of Vessel
          </h5>
