  ...
  <div class="space-y-6">
    ...
    <section class="flex justify-between items-center">
      <h4 class="flex-1 text-[1.125rem] font-semibold font-Poppins text-grey-500">
        Hi,
        <span class="text-secondary-600">Bank of Vessel</span>
        👋🏻
        <!--  {{financierFullname}} -->
      </h4>
      ...
      <div class="col-span-3">
        <CardContainer class="space-y-8 px-8 py-6 flex-col">
          <div class="flex justify-between items-center">
            ...
            <TypoNormalText customClass="cursor-pointer border px-4 py-1.5 rounded">
              2021
            </TypoNormalText>
          </div>
          ...
          <div class="flex justify-between items-center">
            <TypoNormalText customClass="cursor-pointer flex-1">
      ...
      <div class="col-span-2">
        <CardContainer class="space-y-5 px-8 py-6 flex-col">
          ...
          <div class="space-y-4 pb-6">
            <div class="flex justify-between items-center">
              <TypoHeaderText size="sm" customClass="cursor-pointer !text-grey-200">
                Name
              </TypoHeaderText>
