        ...
        <section class="sticky top-0 flex w-full items-center w-full border-b-[3px] border-grey-50">
          <TypoHeaderText
            ...
            :customClass="`
              ...
              ${
                activeTabId == tab.id
                  ? 'border-b-[3px] -mb-0.5 border-primary-500 !text-primary-500'
                  : '!text-grey-200'
              }
            `"
            ...
            <div class="flex-1 flex space-x-3 justify-between items-center">
              <div class="flex space-x-2 items-center">
                <span class="h-9 w-9 relative rounded-full ring-1 ring-secondary-500">
                  ...
                  />
                  <span
                    class="absolute bottom-0 right-0 rounded-full h-2 w-2 bg-success-500"
                  ></span>
                </span>
                ...
                <div class="flex-1 truncate space-y-0.5">
                  ...
                  <TypoNormalText customClass="!text-grey-400 !text-[10px] flex rounded-xl !w-fit">
                    Active now
                  </TypoNormalText>
                </div>
              </div>
              ...
              <div class="flex space-x-3.5 items-center text-grey-200">
                ...
                <Button
                  ...
                  :hasBorder="true"
                  customClass="!py-2 !px-4 !bg-white !font-medium !leading-[160%]"
                />
...
<script setup lang="ts">
  ...
  const messages = ref([
    {
      message:
        'Lorem ipsum dolor sit amet, diam sapien. Porttitor dis tortor cras magnis convallis, vulputate mauris nibh tristique donec. Eros nunc pede nulla. Lorem ipsum dolor sit amet, diam sapien. Porttitor dis tortor cras magnis convallis, vulputate mauris nibh tristique donec. Eros nunc pede nulla.',
      time: '34/87/9703',
      isSent: false,
    },
    {
